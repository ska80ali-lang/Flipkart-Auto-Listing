...
export const CONFIG = {
  ...
  heroVideoUrl: "https://res.cloudinary.com/ddcbu8j1p/video/upload/v1781892192/VID-20260526-WA0006_oz0kys.mp4",
...
export const STATS = [
  ...
  { id: '2', value: 1850, suffix: "+", label: "Active Flipkart Sellers Using This Tool", icon: "Users" },
...
export const SCREENSHOT_SLIDES: ScreenshotSlide[] = [
  ...
  },
  {
    ...
    description: "Our optimization formula in action. It sets Flipkart weight parameters accurately to secure the lowest possible shipping tier legally.",
...
export const PROBLEMS_SOLUTIONS = {
  ...
  problems: [
    ...
    { title: "Low Catalog Visibility", desc: "Creating a few manual listings makes it difficult to get noticed by the Flipkart recommendation algorithm." }
  ],
  solutions: [
    ...
    { title: "Optimized Weight Slabs", desc: "Accurately calibrate package weights and dimensional parameters to trigger Flipkart's lowest local shipping slabs (₹35-₹45)." },
...
export const VIDEO_REVIEWS: VideoReview[] = [
  {
    id: "v1",
    name: "Rahul Verma (Flipkart Master)",
    ...
    videoUrl: "https://res.cloudinary.com/ddcbu8j1p/video/upload/v1781892192/VID-20260526-WA0006_oz0kys.mp4"
  },
  {
    id: "v2",
    ...
    videoUrl: "https://res.cloudinary.com/ddcbu8j1p/video/upload/v1781892256/lv_0_20260529130324_lozzdg.mp4"
  }
];
...
export const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "This method is 100% compliant and safe. It does not violate any Flipkart Vendor Terms of Service. It adjusts specific catalog packing weights and dimensional parameters within official rules to ensure Flipkart automatically places your listings into the lowest shipping weight slabs (saving you ₹40-₹70 per parcel)."
  },
  {
    id: "faq-6",
    question: "How long does it take to see results?",
    answer: "Most sellers set up and launch their first bulk catalog within 25 minutes of downloading the tool. Because Flipkart's algorithm favors consistent product volume, sellers typically see a noticeable rise in listing impressions and initial orders within 24 to 48 hours."
  },
  {
    id: "faq-7",
