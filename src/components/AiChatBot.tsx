        ...
        {isOpen && (
          ...
          >
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    <h4 className="text-xs sm:text-sm font-black text-white tracking-wide">Flipkart Auto-Listing AI Assistant</h4>
            ...
            <div className="p-3 px-4 bg-[#0F172A] border-t border-[#334155] flex items-center justify-between gap-3">
              ...
              {/* Support Number link */}
              <a 
                href="https://wa.me/916295429762?text=Hello,%20I%20visited%20your%20Flipkart%20Auto%20Listing%20AI%20Assistant%20app..."
                target="_blank" 
                rel="noopener noreferrer"
